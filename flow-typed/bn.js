...
declare module 'bn.js' {
  declare class BN {
    ...
    iadd (value: BN): void;
    iaddn (value: number): void;
    uadd (value: BN): BN;
    uaddn (value: number): BN;
    and (value: BN): BN;
    andn (value: number): BN;
    iand (value: BN): void;
    iandn (value: number): void;
    uand (value: BN): BN;
    ...
    idiv (value: BN): void;
    idivn (value: number): void;
    udiv (value: BN): BN;
    udivn (value: number): BN;
    divRound (value: BN): BN;
    divRoundn (value: number): BN;
    idivRound (value: BN): void;
    idivRoundn (value: number): void;
    ...
    imaskn (mask: number): void;
    umaskn (mask: number): BN;
    mod (mod: BN): BN;
    modn (mod: number): BN;
    imod (mod: BN): void;
    imodn (mod: number): void;
    umod (mod: BN): BN;
    umodn (mod: number): BN;
    mul (value: BN): BN;
    muln (value: number): BN;
    imul (value: BN): void;
    imuln (value: number): void;
    umul (value: BN): BN;
    ...
    isub (value: BN): void;
    isubn (value: number): void;
    usub (value: BN): BN;
    usubn (value: number): BN;
    testn (bit: number): BN;
    toArray (endian: number, length: number): Array<number>;
    toArrayLike (type: Class<any>, endian: number, length: number): any;
    toBuffer (endian: number, length: number): Buffer;
    toJSON (): string;
    toNumber (): number;
